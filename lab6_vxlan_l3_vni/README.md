...
[1] Сохранить существующую Leaf–Spine архитектуру и eBGP Underlay.
[2] Создать отдельный VLAN и L2VNI для каждого клиента.
[3] Создать VRF TENANT на Leaf-коммутаторах.
[4] Настроить SVI — шлюзы клиентских сетей.
[5] Связать VRF TENANT с L3VNI 5000.
[6] Настроить распространение клиентских сетей через BGP EVPN.
[7] Проверить состояние EVPN-соседств.
[8] Проверить соответствие VLAN, L2VNI и L3VNI.
[9] Проверить таблицу маршрутизации VRF.
[10] Проверить связность между всеми клиентами.
